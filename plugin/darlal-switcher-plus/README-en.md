...
![Heading Mode gif](headings-mode.gif)
...
![Symbol Mode gif](symbol-mode.gif)
...
![Symbol Mode gif](editor-mode.gif)
...
![headings mode preview](headings-command.png)
...
![symbol outline preview](symbol-outline.png)
...
![editor search preview](edt-command.png)
