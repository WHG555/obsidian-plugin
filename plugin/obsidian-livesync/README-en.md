...
![obsidian_live_sync_demo](137355323-f57a8b09-abf2-4501-836c-8cb7d2ff24a3.gif)
...
1. Hit the "Create Resource" button.
   ![step 1](cloudant_1.png)

1. In IBM Cloud Catalog, search "Cloudant".
   ![step 2](cloudant_2.png)

1. You can choose "Lite plan" for free.
   ![step 3](cloudant_3.png)

Select Multitenant(it's the default) and the region as you like.
![step 4](cloudant_4.png) 3. Be sure to select "IAM and Legacy credentials" for "Authentication Method".
![step 5](cloudant_5.png)

4. Select Lite and be sure to check the capacity.
   ![step 6](cloudant_6.png)

5. And hit "Create" on the right panel.
   ![step 7](cloudant_7.png)
