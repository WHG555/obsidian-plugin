...
![](OrderableAndExpandableRows.gif)
...
![](Suggestion_Window.png)
![](Suggestion_Window_Improved.png)
...
- Version 0.2.2
  - added /mermaid snipplet to generate mermaid code block - allows drawing diagrams ![](Mermaid.png)
- Version 0.2.1
  ⁻ Some Bug Fixes
