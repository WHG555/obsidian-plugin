...
![split by headings demo](Note-Refactor-Demo-Split-by-Headings.gif)
...
![first line file name demo](Note-Refactor-Demo-First-Line-as-File-Name.gif)
...
![content only demo](Note-Refactor-Demo-Content-Only.gif)
...
![note heading demo](Note-Refactor-Demo-Include-First-Line-as-Note-Heading.gif)
