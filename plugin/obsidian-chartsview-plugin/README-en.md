...
![image](119069882-87c95700-ba19-11eb-8cef-02d1e021d1a2.png)


#### WordCloud
Use command `Insert Template...` -> `WordCloud` to insert code block.

![image](119069991-bba47c80-ba19-11eb-873f-847563daea39.png)


#### Treemap
Use command `Insert Template...` -> `Treemap` to insert code block.

![image](119070047-decf2c00-ba19-11eb-9d59-21c051da593c.png)

#### DualAxes
Use command `Insert Template...` -> `DualAxes` to insert code block.

![image](119969638-618b5480-bfe1-11eb-8a36-0a5d60408b00.png)
...
![image](120421841-a1638a80-c399-11eb-9464-d773931fdd6f.png)

#### Bar
Use command `Insert Template...` -> `Bar` to insert code block.

![image](123117024-fa43b180-d473-11eb-84eb-8e1806ce5dec.png)

#### OrganizationTreeGraph
Use command `Insert Template...` -> `OrganizationTreeGraph` to insert code block.

![image](123117254-2b23e680-d474-11eb-845f-0d663a458fa7.png)

#### Radar
Use command `Insert Template...` -> `Radar` to insert code block.

![image](123117394-4a227880-d474-11eb-8a11-23f3cd482251.png)

#### TinyLine
Use command `Insert Template...` -> `TinyLine` to insert code block.

![image](123117476-5a3a5800-d474-11eb-9db8-4b3785bb010c.png)
