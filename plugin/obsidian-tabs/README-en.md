...
- [Multiple tabbed panes](O2fQx2U.mp4).

- When sufficient tabs have been opened, a [second row can be opened](iZJ5byx.mp4). (Optional)
...
- Side by side view \[[demo](horizontalconfigure.webp) and [instructions](#using-split-view)\].
...
#### Using split view
[![video](horizontalconfigure.webp)](horizontalconfigure.webp)
...
[Example of split view usage](lStwTNI.mp4). A tab has been linked to the pane on the right, to make changing its contents easier. The maximise pane plugin is used when only one document needs focusing on.
